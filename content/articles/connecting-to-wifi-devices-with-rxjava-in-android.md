...
> _For the newer API (Android 10) pass the networkCallback you want to unregister, that you got from the WiFiConnectUseCase:_

```
connectivityManager.unregisterNetworkCallback(networkCallback)
```

> _For older APIs (below Android 10), just pass thenetworkIdyou want to remove, that you got from the WiFiConnectLegacyUseCase:_
